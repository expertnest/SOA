  ...
  return (
    <div className="min-h-screen overflow-hidden bg-black text-white">
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-6 p-3 sm:p-6">
        ...
        {/* HERO */}
        <div className="relative overflow-hidden rounded-[34px] border border-white/10 bg-gradient-to-br from-zinc-950 via-zinc-900 to-black p-3 sm:p-6">
          ...
          <div className="relative grid gap-5 xl:grid-cols-[1.15fr_0.85fr]">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-4 sm:hidden">
                ...
                <div className="relative h-[135px] w-[135px] shrink-0 overflow-hidden rounded-3xl border border-white/10">
                  <img
                    src="/headerLogo.png"
                    alt="Artist"
                ...
                <div className="flex flex-1 flex-col justify-between py-1">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-xs leading-relaxed text-zinc-400">
                      Cinematic synths, ambient textures, and futuristic trap energy.
                    </p>
                  </div>

                  <div className="flex flex-wrap gap-2 pt-3">
                    <button className="rounded-full bg-gradient-to-r from-blue-500 to-cyan-400 px-4 py-2 text-xs font-bold text-black">
                      Latest Release
                    </button>

                    <button className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs">
                      Fan Club
                    </button>
                  </div>
              ...
              {/* DESKTOP HERO */}
              <div className="hidden sm:flex md:flex-row gap-5">
              ...
              <div className="sm:hidden overflow-hidden rounded-[28px] border border-white/10 bg-gradient-to-br from-zinc-900 to-black">
            ...
            <div className="hidden sm:flex flex-col gap-5">
              ...
              <div className="rounded-[30px] border border-white/10 bg-gradient-to-br from-zinc-950 to-black p-5">
                ...
                {upcomingShows.map((show, i) => (
                  <div
                    key={i}
                    className="flex justify-between border-b border-white/10 p-3"
                  >
                    <div>
                      <p>{show.city}</p>
